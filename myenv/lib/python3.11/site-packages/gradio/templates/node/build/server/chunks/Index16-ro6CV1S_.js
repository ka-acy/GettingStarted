...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-Ch-Upcn5.js';
...
const lang_map = {
  python: () => import('./index32-HpdRnt72.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-nAKBOrvt.js'),
      import('./frontmatter-CwoLZWMC.js')
    ]);
  ...
  json: () => import('./index37-CeNnd-Ff.js').then((m) => m.json()),
  html: () => import('./index34-DG9KFShV.js').then((m) => m.html()),
  css: () => import('./index35-SdwlHwla.js').then((m) => m.css()),
  javascript: () => import('./index36-D1Ec1XGk.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-D1Ec1XGk.js').then(
...
//# sourceMappingURL=Index16-ro6CV1S_.js.map
